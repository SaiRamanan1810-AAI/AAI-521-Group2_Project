...
def main():
    ...
    # Set history path
    history_path = os.path.join(args.out_dir, f'{args.species}_history.json')
    ...
    ax1.set_title(f'{args.species} Disease Classifier - Loss', fontsize=14, fontweight='bold')
    ...
    ax2.set_title(f'{args.species} Disease Classifier - Accuracy', fontsize=14, fontweight='bold')
    ax2.legend(fontsize=10)
    ax2.grid(True, alpha=0.3)
    plt.tight_layout()
    plot_path = os.path.join(args.out_dir, f'{args.species}_disease_training.png')
